...
/***
 * Provides convenience methods for displaying common dialogs provided by Java.
 * @author JasonWells
 *
 */
public class CommonDialogs {
	 ...
	 * @return The choice the user selected.
	 */
	public static String getSelection(String message, Collection<String> choices, String defaultValue){
		return getSelection(message,choices,defaultValue);
	}
	 ...
	 * @return The choice the user selected.
	 */
	public static String getSelection(String message, Collection<String> choices){
